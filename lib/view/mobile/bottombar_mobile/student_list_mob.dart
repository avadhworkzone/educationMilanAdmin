...
class StudentListDataMobile extends StatefulWidget {
  StudentListDataMobile({
    Key? key,
  }) : super(key: key);

  @override
  State<StudentListDataMobile> createState() => _HomeScreenState();
}

List<StudentModel> filteredData = [];
List<UserResModel> allUserData1 = [];

class _HomeScreenState extends State<StudentListDataMobile> {
  TextEditingController searchController = TextEditingController();
  // int _rowsPerPage = 10;
  bool isLoggingOut = false;
  RangeValues _currentRangeValues = const RangeValues(1, 100);
  List<StudentModel> filteredData = PreferenceManagerUtils.getData();
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        ...
        //                 ),
        //                 mobileBodyLogin: StandardViseDataStudentScreen(
