                  ...
                  children: [
                    ...
                    FutureBuilder<List<StudentModel>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          Widget buildGrid(List<StudentModel> list) {
                          ...
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              if (juniorKgs.isNotEmpty) ...[
                                CustomText("STD Junior KG", fontSize: 20.sp, fontWeight: FontWeight.bold),
                                SizedBox(height: 10.h),
                                buildGrid(juniorKgs),
                                SizedBox(height: 20.h),
                              ],
                              if (seniorKgs.isNotEmpty) ...[
                                CustomText("STD Senior KG", fontSize: 20.sp, fontWeight: FontWeight.bold),
                                SizedBox(height: 10.h),
                                buildGrid(seniorKgs),
                                SizedBox(height: 20.h),
                              ],
                              ...
                              if (others.isNotEmpty) ...[
                                CustomText("Other Standards", fontSize: 20.sp, fontWeight: FontWeight.bold),
                                SizedBox(height: 10.h),
                                buildGrid(others),
                              ],
                            ],
